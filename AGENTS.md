# AGENTS.md — Project guidance for AI assistants working on this project

This file is loaded automatically by Codex (and any AI coding assistant that respects the AGENTS.md convention) at the start of every session in this directory.
