...
The pilot is the first step of a larger thesis question: **which survey-collectible features (demographic, behavioral, psychological, attitudinal) most predict persona fidelity?** Park found that surveys-only (82%) was nearly as predictive as interview-only (83%), motivating a deeper investigation of which survey features matter most. This pilot establishes the evaluation infrastructure for that follow-up.
